...
const Login = () => {
  ...
  return (
    <div>
      <section className="flex justify-center items-center text-white body-font md:bg-gray-900 h-screen sm:h-auto md:h-screen lg:h-screen lg:px-10">
        <div className="container flex px-5 py-8 md:flex-row flex-col items-center ">
          ...
          <div className="md:w-full my-auto flex justify-center items-center flex-col  p-2 md:ml-auto md:bg-gray-800 lg:w-1/2 md:py-8">
            ...
            <form onSubmit={handleSubmit} className="w-full lg:w-3/4">
              ...
              <p className="text-md text-center border-t-2 border-gray-400 py-2 text-white mt-4">
